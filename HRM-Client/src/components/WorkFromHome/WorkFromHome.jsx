...
function WorkFromHome() {
    ...
    const [selectedOption, setSelectedOption] = useState('One'); // Default selected value
    ...
    return (
        <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <label className="container">Tôi cần thiết bị của công ty
                <input
                    type="radio"
                    name="radio"
                    value="One"
            ...
            <label className="container">Tôi không cần thiết bị của công ty
                <input
                    type="radio"
                    name="radio"
                    value="Two"
